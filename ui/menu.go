...
var defaultMenuOptions = []keys.KeyName{keys.KeyNew, keys.KeyCloud, keys.KeyPrompt, keys.KeyHelp, keys.KeyQuit}
...
func (m *Menu) addInstanceOptions() {
	...
	options := []keys.KeyName{keys.KeyNew, keys.KeyCloud, keys.KeyKill}
